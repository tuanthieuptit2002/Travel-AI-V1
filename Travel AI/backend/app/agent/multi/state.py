"""Shared typed state for the controlled multi-agent travel graph."""
...
class MultiAgentState(TypedDict, total=False):
    ...
    # --- candidate catalogs produced by specialist agents ---
    ...
    # --- supervisor control plane (loop / timeout / recovery) ---
